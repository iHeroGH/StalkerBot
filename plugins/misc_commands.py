...
from .stalker_utils.stalker_cache_utils import count_stalkers, count_keywords
...
class MiscCommands(client.Plugin):
    ...
    HELP_TEXT = (
        ...
        "Finally, you can add **filters** for certain *users*, *text phrases*" +
        ", *channels*, and *servers*. These filters prevent you from getting "+
        "DMed about your keyword if it's said by a specific user, in a " +
        "specific text phrase, in a specific channel, " +
