...
async def invite(ctx):
    ...
    '''
    await ctx.send("<https://discord.com/api/oauth2/authorize?client_id=723813550136754216&permissions=0&scope=bot>")
...
async def addkeyword(ctx, keyword):
    ...
    if len(keyword) < 3:
        await ctx.send("That keyword is too short. It must be at least 3 characters")
        return
